...
- [SNI](https://github.com/alttpo/sni/releases). Este viene proporcionado junto a la instalación de MultiworldGG.
...
MultiworldGG no puede proveer ni uno de estos.
...
1. Descarga e instala [ArchipMultiworldGGelago](<https://github.com/MultiworldGG/MultiworldGG/releases/latest>). **El instalador se 
